...
const statusStyles: Record<string, string> = {
  ...
  quoted:
    'bg-secondary text-secondary-foreground border-secondary dark:bg-secondary dark:text-secondary-foreground',
  booked:
    'bg-primary/15 text-primary border-primary/25 dark:bg-primary/25 dark:text-primary',
  completed:
