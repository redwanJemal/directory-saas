...
describe('LoginPage', () => {
  it('renders login form with tenant slug field', () => {
    render(<LoginPage />);
    expect(screen.getByLabelText('auth.tenantSlug')).toBeInTheDocument();
  ...
  it('shows validation error for empty password', async () => {
    ...
    await user.type(screen.getByLabelText('auth.tenantSlug'), 'my-business');
