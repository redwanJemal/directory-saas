You are implementing task "Project Scaffolding — NestJS Monorepo + Prisma + Docker" for the Directory SaaS boilerplate project.
...
These subtasks have already been tracked:
  ...
  - frontend-provider: pending
  - frontend-admin: pending
  - docker: pending
  - scripts: pending
...
5. After ALL work is done, update the progress file at docs/tasks/progress.json:
   - Set tasks.01-project-scaffolding.status to "completed"
   - Set each subtask to "completed" as you finish them
   - Set tasks.01-project-scaffolding.completed_at to current ISO timestamp
   - Add any important notes to tasks.01-project-scaffolding.notes
6. Finally, create a git commit with message: "feat: implement 01-project-scaffolding — Project Scaffolding — NestJS Monorepo + Prisma + Docker"
