You are implementing task "Exception Handling & Error Response Format" for the Directory SaaS boilerplate project.
...
5. After ALL work is done, update the progress file at docs/tasks/progress.json:
   - Set tasks.04-exception-handling.status to "completed"
   - Set each subtask to "completed" as you finish them
   - Set tasks.04-exception-handling.completed_at to current ISO timestamp
   - Add any important notes to tasks.04-exception-handling.notes
6. Finally, create a git commit with message: "feat: implement 04-exception-handling — Exception Handling & Error Response Format"
