You are implementing task "Multi-Tenancy Middleware — Tenant Resolution" for the Directory SaaS boilerplate project.
...
5. After ALL work is done, update the progress file at docs/tasks/progress.json:
   - Set tasks.07-multi-tenancy-middleware.status to "completed"
   - Set each subtask to "completed" as you finish them
   - Set tasks.07-multi-tenancy-middleware.completed_at to current ISO timestamp
   - Add any important notes to tasks.07-multi-tenancy-middleware.notes
6. Finally, create a git commit with message: "feat: implement 07-multi-tenancy-middleware — Multi-Tenancy Middleware — Tenant Resolution"
