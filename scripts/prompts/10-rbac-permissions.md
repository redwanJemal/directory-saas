You are implementing task "RBAC & Permissions System" for the Directory SaaS boilerplate project.
...
These subtasks have already been tracked:
  - roles-module: pending
  - permission-guard: pending
  - decorators: pending
  - caching: pending
  - seed: pending
  - tests: pending
...
5. After ALL work is done, update the progress file at docs/tasks/progress.json:
   - Set tasks.10-rbac-permissions.status to "completed"
   - Set each subtask to "completed" as you finish them
   - Set tasks.10-rbac-permissions.completed_at to current ISO timestamp
   - Add any important notes to tasks.10-rbac-permissions.notes
6. Finally, create a git commit with message: "feat: implement 10-rbac-permissions — RBAC & Permissions System"
