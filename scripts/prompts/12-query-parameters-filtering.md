You are implementing task "Query Parameters — Filters, Sorting, Pagination, Includes" for the Directory SaaS boilerplate project.
...
These subtasks have already been tracked:
  - query-dto: pending
  - filter-parser: pending
  - array-filters: pending
  - sorting: pending
  - pagination: pending
  - includes: pending
  - prisma-builder: pending
  - tests: pending
...
5. After ALL work is done, update the progress file at docs/tasks/progress.json:
   - Set tasks.12-query-parameters-filtering.status to "completed"
   - Set each subtask to "completed" as you finish them
   - Set tasks.12-query-parameters-filtering.completed_at to current ISO timestamp
   - Add any important notes to tasks.12-query-parameters-filtering.notes
6. Finally, create a git commit with message: "feat: implement 12-query-parameters-filtering — Query Parameters — Filters, Sorting, Pagination, Includes"
