You are implementing task "Audit Logging — Entity Change Tracking" for the Directory SaaS boilerplate project.
...
5. After ALL work is done, update the progress file at docs/tasks/progress.json:
   - Set tasks.21-audit-logging.status to "completed"
   - Set each subtask to "completed" as you finish them
   - Set tasks.21-audit-logging.completed_at to current ISO timestamp
   - Add any important notes to tasks.21-audit-logging.notes
6. Finally, create a git commit with message: "feat: implement 21-audit-logging — Audit Logging — Entity Change Tracking"
