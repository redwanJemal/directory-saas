You are implementing task "Full-Text & Vector Search" for the Directory SaaS boilerplate project.
...
5. After ALL work is done, update the progress file at docs/tasks/progress.json:
   - Set tasks.22-search-infrastructure.status to "completed"
   - Set each subtask to "completed" as you finish them
   - Set tasks.22-search-infrastructure.completed_at to current ISO timestamp
   - Add any important notes to tasks.22-search-infrastructure.notes
6. Finally, create a git commit with message: "feat: implement 22-search-infrastructure — Full-Text & Vector Search"
