You are implementing task "AI Module — Vercel AI SDK, Tools, Streaming" for the Directory SaaS boilerplate project.
...
5. After ALL work is done, update the progress file at docs/tasks/progress.json:
   - Set tasks.23-ai-module.status to "completed"
   - Set each subtask to "completed" as you finish them
   - Set tasks.23-ai-module.completed_at to current ISO timestamp
   - Add any important notes to tasks.23-ai-module.notes
6. Finally, create a git commit with message: "feat: implement 23-ai-module — AI Module — Vercel AI SDK, Tools, Streaming"
