You are implementing task "Coding Standards Validator Script" for the Directory SaaS boilerplate project.
...
5. After ALL work is done, update the progress file at docs/tasks/progress.json:
   - Set tasks.25-coding-standards-validator.status to "completed"
   - Set each subtask to "completed" as you finish them
   - Set tasks.25-coding-standards-validator.completed_at to current ISO timestamp
   - Add any important notes to tasks.25-coding-standards-validator.notes
6. Finally, create a git commit with message: "feat: implement 25-coding-standards-validator — Coding Standards Validator Script"
