You are implementing task "Docker Compose — Dev + Coolify Production" for the Directory SaaS boilerplate project.
...
5. After ALL work is done, update the progress file at docs/tasks/progress.json:
   - Set tasks.26-docker-compose.status to "completed"
   - Set each subtask to "completed" as you finish them
   - Set tasks.26-docker-compose.completed_at to current ISO timestamp
   - Add any important notes to tasks.26-docker-compose.notes
6. Finally, create a git commit with message: "feat: implement 26-docker-compose — Docker Compose — Dev + Coolify Production"
