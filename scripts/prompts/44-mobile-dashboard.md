You are implementing task "Mobile Wedding Dashboard — Overview, Stats, Quick Actions" for the Directory SaaS boilerplate project.
...
5. After ALL work is done, update the progress file at docs/tasks/progress.json:
   - Set tasks.44-mobile-dashboard.status to "completed"
   - Set each subtask to "completed" as you finish them
   - Set tasks.44-mobile-dashboard.completed_at to current ISO timestamp
   - Add any important notes to tasks.44-mobile-dashboard.notes
6. Finally, create a git commit with message: "feat: implement 44-mobile-dashboard — Mobile Wedding Dashboard — Overview, Stats, Quick Actions"
