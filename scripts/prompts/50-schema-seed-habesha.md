You are implementing task "Schema & Seed — Habesha Hub Domain" for the Habesha Hub project (Ethiopian Business Directory for the Middle East).
...
These subtasks have already been tracked:
  ...
  - migration: pending
  - seed-categories: pending
  - seed-demo-businesses: pending
  - update-dtos: pending
  - tests: pending
...
5. After ALL work is done, update the progress file at docs/tasks/progress.json:
   - Set tasks.50-schema-seed-habesha.status to "completed"
   - Set each subtask to "completed" as you finish them
   - Set tasks.50-schema-seed-habesha.completed_at to current ISO timestamp
   - Add any important notes to tasks.50-schema-seed-habesha.notes
6. Finally, create a git commit with message: "feat: implement 50-schema-seed-habesha — Schema & Seed — Habesha Hub Domain"
