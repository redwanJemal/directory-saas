You are implementing task "Web App — Business Profile Page" for the Habesha Hub project (Ethiopian Business Directory for the Middle East).
...
These subtasks have already been tracked:
  ...
  - whatsapp-cta: pending
  - review-submission: pending
  - share-social: pending
...
5. After ALL work is done, update the progress file at docs/tasks/progress.json:
   - Set tasks.58-web-business-profile.status to "completed"
   - Set each subtask to "completed" as you finish them
   - Set tasks.58-web-business-profile.completed_at to current ISO timestamp
   - Add any important notes to tasks.58-web-business-profile.notes
6. Finally, create a git commit with message: "feat: implement 58-web-business-profile — Web App — Business Profile Page"
