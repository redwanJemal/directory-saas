You are implementing task "i18n — Amharic & Arabic" for the Habesha Hub project (Ethiopian Business Directory for the Middle East).
...
These subtasks have already been tracked:
  - amharic-translations: pending
  - arabic-translations: pending
  - rtl-support: pending
  - language-switcher: pending
  - provider-admin-translations: pending
...
5. After ALL work is done, update the progress file at docs/tasks/progress.json:
   - Set tasks.62-i18n-amharic-arabic.status to "completed"
   - Set each subtask to "completed" as you finish them
   - Set tasks.62-i18n-amharic-arabic.completed_at to current ISO timestamp
   - Add any important notes to tasks.62-i18n-amharic-arabic.notes
6. Finally, create a git commit with message: "feat: implement 62-i18n-amharic-arabic — i18n — Amharic & Arabic"
